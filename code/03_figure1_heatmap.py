...
summer_file = r"...\data\01_figure1_data\summer.csv"
winter_file = r"...\data\01_figure1_data\winter.csv"
output_dir = ""
city_col = "city"
hour_col = "hour"
...
for city in df_summer[city_col].unique():
    ...
    for i, label_text in enumerate(season_labels):
        y_center = i + 0.5
        ax.text(left_margin + 1.5, y_center, label_text, ha='center', va='center', fontsize=14)
        rect_width = 1
        rect_height = 1
    ...
    ax.text(city_rect_x + group_width/2, city_rect_y + city_rect_height/2,
            city, ha='center', va='center', fontsize=16, fontweight='bold')
    plt.xlabel("hour", fontsize=16)
    plt.tight_layout()

    output_path = os.path.join(output_dir, f"{city}.svg")
